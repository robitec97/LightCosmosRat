...
namespace LightCosmosRat
{
	...
	/// </summary>
	public partial class ClientMaker : Form
	{
        private StringBuilder sb;
        public bool customIcon;
        private string defaultCompilerOptions = "/t:winexe";
		public ClientMaker()
		{
			//
        ...
        public static bool CompileExecutable(String sourceName, TextBox tb, bool customIcon = false, string iconPath = "")
        {
            ...
            if (provider != null)
            {
                ...
                if (customIcon)
                {
                    cp.CompilerOptions = "/t:winexe " + "/win32icon:" + iconPath;
                }
                else
                {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            bool CompilerResults = CompileExecutable("ClientRat.cs",textBox3,customIcon,iconText.Text);
            Thread.Sleep(1000);
        ...
        {
            if (!iconDialog.FileName.ToLower().EndsWith(".ico"))
            {
                e.Cancel = true;
                MessageBox.Show("You need to choose a icon file!", "Invalid format", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }

            iconText.Text = iconDialog.FileName;
            customIcon = true;
